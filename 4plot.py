### Plots position graphs for any snapshot with vz color bars for star and gas ###
### [0] = Gas ###
### [4] = Star ###
...
plt.subplot(121)
plt.hexbin(star_px_xy, star_py_xy, C=star_vz_bar, cmap=cm.jet_r, gridsize=300, vmin=-20, vmax=20)
