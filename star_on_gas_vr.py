### Plots x vs y position graphs with vr color bar for gas ###
### Left graph is just vr coloring and right graph is vr coloring with blue position of stars on top to make it easier to see the spiral arms ###
### [0] = Gas ###
### [4] = Star ###
...
import glio
s = glio.GadgetSnapshot('snapshot_003')		### Change snapshot here ###
s.load()
...
plt.xlabel('x')
plt.ylabel('y')
plt.text(20, 20, 't = 10')				### Make sure to change time label ###
