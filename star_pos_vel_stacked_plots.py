...
########## Sets up the  x, y, and z postion arrays for the star ##########
...
for i in range(len(star_centered_y)):
	if 1.0 >= star_centered_y[i] >= 0.0:
		x_slice.append(star_centered_x[i])
		y_slice.append(star_centered_y[i])
		vr_slice.append(star_centered_vr[i])
		vtheta_slice.append(star_centered_vtheta[i])
		vz_slice.append(star_centered_vz[i])
