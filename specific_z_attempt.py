...
file_x = open('data_gas_x')
gas_x = file_x.readlines()
...
file_y = open('data_gas_y')
gas_y = file_y.readlines()
...
file_z = open('data_gas_z')
gas_z = file_z.readlines()
...
plt.plot(x_new, y_new, '.', markersize=3, alpha=0.3)
plt.show()