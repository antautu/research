### Plots star and gas position graphs for any snapshot with vr color bars ###
### [0] = Gas ###
### [4] = Star ###
...
plt.subplot(121)
plt.hexbin(star_px_xy, star_py_xy, C=None, cmap=cm.Set1, gridsize=(1000,1000))
...
plt.subplot(122)
plt.hexbin(star_px_xy, star_py_xy, C=star_vr_bar, cmap=cm.Set1, gridsize=(100,100), vmin=-120, vmax=120)
