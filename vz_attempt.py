### Plots star and gas position graphs for any snapshot with vz  color bars ###
### [0] = Gas ###
### [4] = Star ###
...
plt.subplot(121)
plt.hexbin(star_px_xy, star_py_xy, C=star_vz_bar, cmap=cm.jet_r, gridsize=300, vmin=-12, vmax=12)
...
plt.subplot(122)
plt.hexbin(gas_px_xy, gas_py_xy, C=gas_vz_bar, cmap=cm.jet_r, gridsize=300, vmin=-12, vmax=12)
