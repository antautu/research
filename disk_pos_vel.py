...
plt.subplot(121)
plt.plot(disk_centered_x, disk_centered_vr, '.', markersize=3, alpha=0.3)
...
plt.subplot(121)
plt.plot(disk_centered_x, disk_centered_vtheta, '.', markersize=3, alpha=0.3)
...
plt.subplot(121)
plt.plot(disk_centered_x, disk_centered_vz, '.', markersize=3, alpha=0.3)
