...
plt.subplot(121)
plt.plot(gas_centered_x, gas_centered_vr, '.', markersize=3, alpha=0.3)
plt.title('Gas x vs vr', fontsize=22)
plt.xlabel('x (kpc)', fontsize=18)
...
plt.subplot(121)
plt.plot(gas_centered_x, gas_centered_vtheta, '.', markersize=3, alpha=0.3)
plt.title('Gas x vs vtheta', fontsize=22)
plt.xlabel('x (kpc)', fontsize=18)
...
plt.subplot(121)
plt.plot(gas_centered_x, gas_centered_vz, '.', markersize=3, alpha=0.3)
plt.title('Gas x vs vz', fontsize=22)
plt.xlabel('x (kpc)', fontsize=18)
